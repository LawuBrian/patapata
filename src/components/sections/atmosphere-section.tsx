        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {atmosphereItems.map((item, i) => (
            <AnimatedSection key={item.title} delay={i * 0.2}>
              {/* Proximity: image, overlay text and caption all grouped as one unit */}
              <motion.div
              ...
              >
                ...
                {/* Caption — Proximity: immediately below its image */}
                ...
                {/* Amber bottom border — Repetition: matches DishCard and CocktailCard */}
