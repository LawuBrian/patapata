...
export function BrandStorySection() {
  ...
  // Row 1 video moves slightly slower — feels farther away
  const videoY = useTransform(scrollYProgress, [0, 1], [-18, 18]);
  // Row 2 landscape image moves a bit faster — feels closer
  const imgY = useTransform(scrollYProgress, [0, 1], [-28, 28]);

  return (
    <section ref={sectionRef} className="relative bg-cream py-16 md:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center mb-16 md:mb-24">
          ...
          <AnimatedSection>
            <div className="relative aspect-[3/4] overflow-hidden rounded-sm bg-charcoal">
              ...
              {/* Overlay and badge stay fixed relative to container */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          {/* Right — landscape image with parallax */}
